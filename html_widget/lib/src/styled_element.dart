...
class StyledElement {
  ...
  Map<String, String> get attributes =>
      _node.attributes.map((dynamic key, value) {
...
StyledElement parseStyledElement(
  ...
  switch (element.localName) {
    ...
    case 'b':
      ...
      break;
    case 'bdo':
      final textDirection = ((element.attributes['dir'] ?? 'ltr') == 'rtl')
          ? TextDirection.rtl
          : TextDirection.ltr;
      styledElement.style = Style(
    ...
    case 'big':
      ...
      break;
    case 'blockquote':
      //ODO(Sub6Resources) this is a workaround for collapsing margins. Remove.
    ...
    case 'ol':
    case 'ul':
      //TOD(Sub6Resources): This is a workaround for collapsed margins. Remove.
